            ...
            <table className="table">
                <thead className="table-info">
                    <tr className="text-center">
                        <th style={{ cursor: 'pointer' }} onClick={() => handleSort('id')}>Id
                            {sortConfig.key === 'id' ? (
                            sortConfig.direction === 'asc' ? <FaSortUp className="ms-2 fs-3 text-success" /> :   <FaSortDown className="ms-2 fs-3" />
                            ) : (
                                    <FaSort className="ms-2 fs-3" />
                            )}
                        </th>
                        <th>Img</th>
                        <th style={{ cursor: 'pointer' }} onClick={() => handleSort('title')}>Nombre
                        ...
                        <th style={{ cursor: 'pointer' }} onClick={() => handleSort('category')}>Categorias
                        ...
                        <th style={{ cursor: 'pointer' }} onClick={() => handleSort('brand')}>Marcas
                        ...
                        <th style={{ cursor: 'pointer' }} onClick={() => handleSort('stock')}>Stock
                ...
                <tbody>
                    {paginatedData.map((item)=>(
                        ...
                        <td><Link to={`/detalle/${item.id}/${item.title}`} href="#"
